  ...
  async loadAssets(gameContext) {
    ...
    await assetLoader.loadAssets({
      audio: {
        ...
        'success.det-har-du-styr-på': "/audio/success/det-har-du-styr-paa.mp3",
        ...
        'success.fænomenalt': "/audio/success/faenomenalt.mp3",
        'success.godt-gættet': "/audio/success/godt-gaettet.mp3",
        ...
        'success.sádan': "/audio/success/saadan.mp3",
